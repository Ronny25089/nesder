...
1. 安装Node.js，并执行一下命令，安装http-server[※NodeJS安装方法参考](https://www.runoob.com/nodejs/nodejs-install-setup.html)  
...
# 接口测试
1. 打开PostMan(或者其他API测试工具)，输入以下URL(localhost/nesder/account/all)，并发送GET请求。若能看到下面这样的response，即服务器搭建成功！
